...
<template>
  <el-card class="box-card" shadow="always">
    ...
    <el-card>
      ...
      <div>
        去下面链接获取到user_access_token，放到运行起来的项目中，点击下载
      </div>

      <a href="https://open.feishu.cn/api-explorer/cli_a52b4df38b7b500c?apiName=create&project=authen&resource=oidc.access_token&version=v1" target="_blank">飞书开发者平台</a>
    </el-card>
